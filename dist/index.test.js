...
test("should handle nested objects", () => {
    assert.strictEqual(deepEqual({ user: { name: "Alice", age: 30 } }, { user: { name: "Alice", age: 30 } }), true);
});
test("should return false for different nested objects", () => {
    assert.strictEqual(deepEqual({ user: { name: "Alice", age: 30 } }, { user: { name: "Bob", age: 30 } }), false);
});
...
test("should handle objects with mixed types", () => {
    assert.strictEqual(deepEqual({ str: "hello", num: 42, bool: true, nil: null }, { str: "hello", num: 42, bool: true, nil: null }), true);
});
// ============================================================================
// Dates
// ============================================================================
...
test("should return false for map vs object", () => {
    ...
    assert.strictEqual(deepEqual(map, { x: 1 }), false);
});
test("should return false for set vs array", () => {
    const set = new Set([1, 2, 3]);
    assert.strictEqual(deepEqual(set, [1, 2, 3]), false);
});
test("should return false for date vs string", () => {
    const date = new Date("2026-05-02");
    assert.strictEqual(deepEqual(date, "2026-05-02"), false);
});
...
test("should return false for TypedArray vs DataView", () => {
    ...
    assert.strictEqual(deepEqual(typedArr, view), false);
});
